...
export default function CompanyHeader(){
    return (
        <header data-role="Header" className="company-profile-header">
          <div className="company-profile-container02">
            <img
              alt="image"
          ...
          <div className="company-profile-btn-group">
            <button className="company-profile-button button">LOGOUT</button>
          </div>
          <div data-type="BurgerMenu" className="company-profile-burger-menu">
            <svg viewBox="0 0 1024 1024" className="company-profile-icon">
              <path
                d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"
              ></path>
            </svg>
          </div>
          <div data-type="MobileMenu" className="company-profile-mobile-menu">
            <nav className="company-profile-nav1">
              <div className="company-profile-container03">
                <img
                  alt="image"
                ...
                >
                  <svg viewBox="0 0 1024 1024" className="company-profile-icon02">
                    <path
              ...
              <nav
                className="navigation-links-nav navigation-links-root-class-name8"
              >
                <span className="navigation-links-text"><span><a href="/student/BT18CSE031">Profile</a></span></span>
